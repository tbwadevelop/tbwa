	...
	$("body").on("click","#dep",function(){
		for (var i = 0; i<Departamentos.length; i++) {		
				$('#dep').append("<option value="+Departamentos[i]+">"+Departamentos[i]+"</option>");			
		};
	});
	...
	function re($posicion){
		for (var c = 0; c < Ciudades[$posicion].length; c++) {
				$('#city').append("<option value="+Ciudades[$posicion][c]+">"+Ciudades[$posicion][c]+"</option>");	
		};
	}
